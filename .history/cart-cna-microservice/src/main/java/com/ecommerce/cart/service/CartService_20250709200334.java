...
public class CartService {
     ...
     */
    public Mono<Cart> getCart(Integer userId) {  // CHANGED: Long -> Integer
     ...
     * Add item to cart
     */
    public Mono<Cart> addItemToCart(Integer userId, CartItem item) {  // CHANGED: Long -> Integer
     ...
     */
    public Mono<Cart> removeItemFromCart(Integer userId, Integer productId) {  // CHANGED: Long -> Integer
        return getCart(userId)
                .flatMap(cart -> {
     ...
     */
    public Mono<Cart> updateItemQuantity(Integer userId, Integer productId, int quantity) {  // CHANGED: Long -> Integer
        return getCart(userId)
                .flatMap(cart -> {
     ...
     * Clear entire cart
     */
    public Mono<Boolean> clearCart(Integer userId) {  // CHANGED: Long -> Integer
        String redisKey = "cart:" + userId;
     ...
     */
    public Mono<Boolean> cartExists(Integer userId) {  // CHANGED: Long -> Integer
        String redisKey = "cart:" + userId;
     ...
     * Get cart item count
     */
    public Mono<Integer> getCartItemCount(Integer userId) {  // CHANGED: Long -> Integer
        return getCart(userId)
     ...
     * Get cart total
     */
    public Mono<Float> getCartTotal(Integer userId) {  // CHANGED: Long -> Integer
        return getCart(userId)
                .map(Cart::getTotal);
    }
     ...
     */
    public Mono<Boolean> validateCart(Integer userId) {  // CHANGED: Long -> Integer
        return getCart(userId)
                .map(cart -> {
                    if (cart.isEmpty()) {
                        return false;

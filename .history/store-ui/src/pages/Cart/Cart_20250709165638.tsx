...
// Simulated API call to create an order
async function createOrder({
    userId,
    items,
    total,
    currency,
}: { userId: any; items: CartItem[]; total: number; currency: string; }) {
...
function createOrder(arg0: { userId: any; items: CartItem[]; total: number; currency: string; }) {

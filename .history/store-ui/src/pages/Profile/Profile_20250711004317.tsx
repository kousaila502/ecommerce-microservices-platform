                  ...
                  <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} sm={6}>
                      <TextField
                        ...
                        value={isAdmin ? user.id : (user.created_at ? formatJoinDate(user.created_at) : 'N/A')}
                        disabled
                        variant="filled"
                        helperText={isAdmin ? "Your unique identifier" : "Date you joined TechMart"}
                      />
                    </Grid>
                  </Grid>
                </form>
            ...
            <Grid item xs={12} md={4}>
              ...
              <Paper elevation={2} sx={{ p: 3, borderRadius: 2 }}>
                ...
                <Typography variant="body2" color="text.secondary" gutterBottom>
                  Account Status: <Chip label={user.status || 'Active'} size="small" color="success" />
                </Typography>

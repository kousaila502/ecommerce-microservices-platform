...
// API URLs for all microservices - UPDATED TO SECURE HTTPS ENDPOINTS
...
export const usersUrl = process.env.REACT_APP_USERS_URL_BASE || 'https://34.95.5.30.nip.io/user/'
export const ordersUrl = process.env.REACT_APP_ORDERS_URL_BASE || 'https://34.95.5.30.nip.io/order/'
export const adminUrl = process.env.REACT_APP_ADMIN_URL_BASE || 'https://34.95.5.30.nip.io/admin/';
